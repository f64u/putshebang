...
from .main import ShebangedFile, UnshebangedFile, ShebangNotFoundException, which
from typing import List

__all__ = ["ShebangedFile", "UnshebangedFile", "ShebangNotFoundException", "which"]
...
def shebang(file_name, lang=None, get_versions=False, get_symlinks=False):
    ...
    """
    return list(map(lambda s: "#!{}".format(s), ShebangedFile.get_interpreter_path(
                                                file_name,
                                                lang,
                                                get_versions,
                                                get_symlinks=get_symlinks)[1]))
